"""
Script para visualizar el grafo del Agente RAG
===============================================

Este script genera una visualización del grafo del Agente RAG usando LangGraph.
La imagen se guarda en app/images/rag_agent_graph.png
...
try:
    ...
    print("  docker exec -it app python scripts/visualize_rag_graph.py\n")
    print("OPCIÓN 2: Instalar dependencias localmente")
    print("  pip install -r requirements.txt")
    print("  python scripts/visualize_rag_graph.py\n")
    print("="*60)
    sys.exit(1)

from flows.rag_agent import visualize_graph
import logging
...
if __name__ == "__main__":
    logger.info("Generando visualización del grafo RAG...")
